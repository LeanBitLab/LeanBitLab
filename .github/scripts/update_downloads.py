...
def generate_stats_card(total_stars, total_downloads, repo_count, output_path="stats.svg"):
  ...
  <style>
    ...
    .stat-label {{ font: 400 14px 'Segoe UI', Ubuntu, Roboto, sans-serif; fill: #9e9e9e; }}
    .stat-value {{ font: 600 14px 'Segoe UI', Ubuntu, Roboto, sans-serif; fill: #ffffff; }}
    .rank-text {{ font: 700 24px 'Segoe UI', Ubuntu, Roboto, sans-serif; fill: #7C4DFF; }}
    .bg {{ fill: #0d0f17; stroke: #2a2a3c; stroke-width: 1px; rx: 10px; }}
    .circle-bg {{ fill: none; stroke: #1e1e2d; stroke-width: 6; }}
    .circle-progress {{ fill: none; stroke: #7C4DFF; stroke-width: 6; stroke-linecap: round; stroke-dasharray: 170; stroke-dashoffset: 20; }}
  </style>
  <rect class="bg" width="494" height="194" x="0.5" y="0.5" rx="10"/>
  ...
  <g transform="translate(25, 35)">
    ...
    <text x="25" y="4" class="header">LeanBitLab's GitHub Stats</text>
  </g>
  ...
  <g transform="translate(25, 60)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="175" y="13" class="stat-value">{stars_fmt} ({total_stars:,})</text>
    </g>
    
    <!-- Total Downloads -->
    <g transform="translate(0, 26)">
      <path fill="#7C4DFF" d="M8 12L3 7H6V0H10V7H13L8 12ZM0 14H16V16H0V14Z"/>
      <text x="25" y="13" class="stat-label">Total Downloads:</text>
      <text x="175" y="13" class="stat-value">{downloads_fmt} ({total_downloads:,})</text>
    </g>
    ...
    <g transform="translate(0, 52)">
      ...
      <text x="25" y="13" class="stat-label">Public Repositories:</text>
      <text x="175" y="13" class="stat-value">{repo_count}</text>
    </g>
    ...
    <g transform="translate(0, 78)">
      ...
      <text x="175" y="13" class="stat-value">2.2k+</text>
    </g>
  </g>

  <!-- Rank Badge Circle -->
  <g transform="translate(380, 100)">
    <circle class="circle-bg" cx="0" cy="0" r="32"/>
    <circle class="circle-progress" cx="0" cy="0" r="32"/>
    <text class="rank-text" x="0" y="8" text-anchor="middle">A+</text>
  </g>
</svg>'''
...
def main():
    ...
    # Filter out internal .github repo from count
